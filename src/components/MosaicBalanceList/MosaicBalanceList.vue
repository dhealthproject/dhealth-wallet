                ...
                <div class="mosaicList secondary_page_animate">
                    <div v-for="(entry, index) in filteredBalanceEntries" :key="index" class="mosaic_data">
                        <span class="img_container">
                            <img v-if="entry.id.equals(networkMosaic)" src="@/views/resources/img/symbol/DHPCoin.png" alt />
                            <img v-else src="@/views/resources/img/symbol/DHPCoin.png" class="grayed-xym-logo" />
                        </span>
                ...
                <div class="mosaic-data-list">
                    ...
                    >
                        <span class="namege_img">
                            ...
                            />
                            <img v-if="entry.id.equals(networkMosaic)" src="@/views/resources/img/symbol/DHPCoin.png" class="mosaicIcon" />
                            <img v-else src="@/views/resources/img/symbol/DHPCoin.png" class="mosaicIcon grayed-xym-logo" />
                        </span>
